      ...
      <div className="textformContainer" style={props.mode}>
        <div className="textformInline">
          ...
          <div className="textformButtons">
            <button disabled={text.length === 0} onClick={handleUpClick}>
              Convert to UpperCase
            </button>
            <button disabled={text.length === 0} onClick={handleLoCase}>
              Convert to LowerCase
            </button>
            <button disabled={text.length === 0} onClick={clearText}>
              Clear Text
            </button>
            <button disabled={text.length === 0} onClick={handleCopy}>
              Copy Text
            </button>
            <button disabled={text.length === 0} onClick={removeExtraSpaces}>
              Remove Extra Spaces
            </button>
          </div>
          <div className="textformSummaryBox">
            ...
            <p>
              ...
              and {text.split(" ").join("").length} Characters.
            </p>
